...
from modules import arm, leg, reverse_foot, hand
...
hand.rig_hand(type='l_hand', name='L_Hand', thumb=True, amount=4)
hand.rig_hand(type='r_hand', name='R_Hand', thumb=True, amount=4)
